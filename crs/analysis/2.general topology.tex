...
Precisely, we can sum them in order to make another metric out of old two metrics.
Repeating, it is easy to check the finite sum of metrics is also a metric.
