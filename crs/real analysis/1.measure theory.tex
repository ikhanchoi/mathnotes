...
In this section, we assume every base space $X$ is locally compact Hausdorff (Why?).
In locally compact Hausdorff spaces, compact finiteness and locally finiteness are equivalent.
We will consider locally finite Borel measures as the minimally compatible measures with a given topology on $X$.
\begin{defn}
...
\end{prop}
\begin{pf}
First we prove for Borel sets of finite measure.
...
\end{prop}
\begin{cor}
If $X$ is second countable, then every locally finite Borel measure is regular and also Radon.
\end{cor}
