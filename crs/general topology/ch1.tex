...
This also occurs on checking continuity of functions.
...
In this situation, the two metrics is also said to induce exactly the same topology.
...
\end{prop}
\begin{pf}
It is easily deduced by applying the lemma \ref{} twice.
\end{pf}
