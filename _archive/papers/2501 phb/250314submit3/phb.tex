...
\email{choi@ms.u-tokyo.ac.jp}
\subjclass[2020]{46L05, 46L10, 47L50}
...
\begin{enumerate}
\item[(1)] If $|t|\le2^{-1}\delta^{-\frac14}$ and $\delta\le1$, then $t\le f_\delta(t)+\delta^{\frac12}$.
\item[(2)] If $t\ge0$ and $c\ge0$, then $f_\delta(t+c)\le f_\delta(t)+c$.
\item[(3)] If $0\le t\le1$, then $(1+\delta)^{-1}t\le f_\delta(t)$.
\end{enumerate}
\end{lemma}
\begin{proof}
(1)
