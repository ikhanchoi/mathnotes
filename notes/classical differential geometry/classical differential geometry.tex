...
\[\pd_tf=f',\quad\pd_xf=f_x,\quad\pd_if=f_i,\quad\pd_vf=f_v.\]
\[\pd_tX=X',\quad\pd_xX=X_x,\quad\pd_iX=X_i,\quad\pd_vX=X_v.\]

Unless indicated otherwise, \emph{every subscript letter without vertical substitution bar} will be devoted to denote partial derivatives.
