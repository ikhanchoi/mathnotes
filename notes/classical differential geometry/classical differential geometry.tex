...
This curve is an example of cylindrical helices.
\end{ex}
\begin{ex}
Let $\a:\R\to\R^3$ be a map given by
\[\a(t)=(t^3,t^6,t^9).\]
...
(In fact, the identification $T_p\R^3=\R^3$ is \emph{natural}.)
\end{rmk}
...
This parametrization is a general choice for the local study of curves.
\begin{defn}
