...
\begin{prb}[Definition of polygon]
\begin{parts}
\item
\end{parts}
\end{prb}
...
definition of cycles of each vertex
\begin{parts}
\item
\end{parts}
\end{prb}

\begin{prb}[Cycle conditions]
Let $D$ be a polygon with a side pairing identification.
...
\end{cd}
\begin{parts}
\item If every cycle of finite points is finite, then $\im p$ is open.
\item If every cycle of ideal points is finite, then $\im p$ is convex. (not proved)
\item If every cycle is finite, then we can induce a metric on $\bar D/\sim$ such that $\pi z_n\to\pi z$ in $\bar D/\sim$ if and only if there are $h_n\in\Gamma$ such that $h_nz_n\to z$ in $\H^2$.
\item $p$ is a local homeomorphism if and only if elliptic cycle condition is satisfied.
\item $\bar D/\sim$ is complete if and only if parabolic cycle condition is satisfied.
\end{parts}
\end{prb}
\begin{pf}
(c)
...
\bar D \rar{\pi} & \bar D/\sim \rar & \H^2/\Gamma
\end{cd}
Suppose every cycle of $D$ is finite.
\begin{parts}
\item If $D$ satisfies the parabolic condition, then $p$ is surjective.
\item If $D$ satisfies the elliptic condition, then $p$ is injective.
\end{parts}
\end{prb}
\begin{pf}
(a)
