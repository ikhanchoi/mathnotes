...
\item Let $G$ be a group. Show that $G$ is abelian if $|G|=p^2$ for a prime $p$.
\item Let $G$ be a group. Show that $G$ is abelian if it has a surjective cube map.
\item Let $G$ be a finite group. Show that a subgroup of least prime divisor index is normal.
