...
\Step[1]{A kind of continuity.}
We claim
\[|x-y|\le\frac1n\impl|f_n(x)-f_n(y)|\le\frac5n.\]

\Step[2]{$f$ is uniformly continuous.}
For $\e>0$, let $N:=\ceil{\frac{15}\e}$.
We claim
\[n>N,\ |x-y|\le\frac1N\impl|f_n(x)-f_n(y)|\le\frac\e3.\]
We can have two cases:
\[|x-y|\le\frac1n,\c{or}\frac1n<|x-y|\le\frac1N.\]
For the former case, by the inequality proved in Step 1, we have
\[|f_n(x)-f_n(y)|\le\frac5n<\frac5N\le\frac\e3.\]
For the latter case, by the assumption at the beginning, we have
\[|f_n(x)-f_n(y)|\le|x-y|\le\frac1N<\frac\e3.\]
...
\[n>n_x\impl |f_n(x)-f(x)|<\frac\e3\]
and
\[n>n_y\impl |f_n(y)-f(y)|<\frac\e3.\]
Choosing an integer $n$ such that $n>\max\{n_x,n_y,N\}$, we have
\[n>n_x,\quad n>n_y,\c{and} n>N,\ |x-y|<\frac1N,\]
so an inequality follows:
\[|f(x)-f(y)|\le\frac\e3+\frac\e3+\frac\e3=\e.\]
