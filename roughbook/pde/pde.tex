...
for any $0<\e\le2$.
\end{lem}
Note that $|E|\les Q(t)^\e$ does not prove global boundedness of $Q(t)$ since we cannot aplly Gronwall argument if $Q(t)=\infty$.
\begin{pf}
Fix time $t$.
For $2p<N<2q$,
\begin{align*}
...
so by letting $\e=3-q$,
\[\|E(t,x)\|_{L_x^\infty}\les\|\rho(t,x)\|_{L_x^\infty}^{(3-q)/3}\les Q(t)^\e\]
for any $0<\e\le2$.
