...
We use the east coast sign convention and the Einstien summation convention.
Let $M:=\R^{1,3}$ be the Minkowski space.
Consider a line bundle $L$ over $M$ and take an open subset $U$ of $M$ on which the bundle is trivialized.
