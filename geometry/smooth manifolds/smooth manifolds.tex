...
% In this note,
% we only consider something smooth
% we only focus on analytic details of smooth manifolds
% we do not consider algebraic invariants
%  (they weill be treated in differential topology)
