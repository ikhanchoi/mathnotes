...
\begin{prb}[Isoperimetric inequality]
\end{prb}
\begin{prb}[Four vertex theorem]
\end{prb}
\begin{prb}[Ovals]
\end{prb}

\subsection*{Global theory of surfaces}
\begin{prb}[Minimal surfaces]
\end{prb}
\begin{prb}[Classification of compact surfaces]
\end{prb}
\begin{prb}[Hilbert theorem]
\end{prb}

\subsection*{Total curvatures}
\begin{prb}[Fary-Minor theorem]
\end{prb}
\begin{prb}[Fenchel's theorem]
\end{prb}
\begin{prb}[The Gauss-Bonnet theorem]
\end{prb}
